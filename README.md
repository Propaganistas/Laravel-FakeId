...
This package features a slightly modified version of Laravel's built-in `Illuminate\Routing\Router` class and injects it into the IoC container. If you are using a custom `Router` of your own, this package won't work.
